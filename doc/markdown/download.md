...
- __OMPL.app__ 1.4.0, released  ([release notes](releaseNotes.html)):

  <a href="https://bitbucket.org/ompl/ompl/downloads/omplapp-1.4.0-Source.tar.gz" class="btn btn-primary btn-sm">TGZ</a>
  <a href="https://bitbucket.org/ompl/ompl/downloads/omplapp-1.4.0-Source.zip" class="btn btn-primary btn-sm">ZIP</a><br><br>

  OMPL.app is also available through the macOS MacPorts package manager (type “sudo port install ompl +app”).

- __OMPL__ 1.4.0, released  ([release notes](core/releaseNotes.html)):
  ...
  <a href="https://bitbucket.org/ompl/ompl/downloads/ompl-1.4.0-Source.tar.gz" class="btn btn-primary btn-sm">TGZ</a>
  <a href="https://bitbucket.org/ompl/ompl/downloads/ompl-1.4.0-Source.zip" class="btn btn-primary btn-sm">ZIP</a><br><br>
...
- [Installation script for Ubuntu 14.04, 15.10, 16.04, and 17.10](install-ompl-ubuntu.sh)
